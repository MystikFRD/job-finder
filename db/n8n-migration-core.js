...
const runMigration = node({
  ...
  config: {
    ...
    parameters: {
      ...
      query: `-- Job Finder core migrations: save_job_safe, missing columns, search_runs extensions
...
export default workflow('job-finder-migration-core', 'Job Finder Migration core')
  .add(start)
  .to(runMigration);
