...
const runMigration = node({
  ...
  version: 2.7,
  config: {
    name: 'Run crm migration',
    parameters: {
      operation: 'executeQuery',
      query: `-- CRM tables: companies, applications, events, documents, emails, user profile
...
export default workflow('job-finder-migration-crm', 'Job Finder Migration crm')
  .add(start)
  .to(runMigration);
