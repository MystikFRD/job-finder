...
const runMigration = node({
  type: 'n8n-nodes-base.postgres',
  version: 2.7,
  config: {
    name: 'Run phases 456 migration',
    parameters: {
      operation: 'executeQuery',
      query: `-- Phase 4-6: email settings, action items, drafts, interviews, assistant cache
...
export default workflow('job-finder-migration-phases456', 'Job Finder Migration phases456')
  .add(start)
  .to(runMigration);
